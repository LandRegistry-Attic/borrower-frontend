    ...
    "deed": {
        "additional_provisions": [
            ...
            },
            {
                ...
                "description": "This mortgage deed incorporates the Mortgage Conditions (Issue 'J') which have been laid down by the Board of Directors of the lender and of which a copy has been supplied to the borrower."
            },
            {
        ...
        "charge_clause": {
            "cre_code": "CRE001",
            "description": "The borrower, with full title guarantee, charges to the lender the property by way of legal mortgage with payment of all money secured by the charge."
        },
